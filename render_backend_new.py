...
CMS_BASE_URL = "https://api.cms.gov/marketplace"  # ✅ Corrected CMS API base URL
...
def get_quotes(request: QuoteRequest):
    ...
    try:
        # ✅ Using the correct CMS API endpoint
        response = requests.get(f"{CMS_BASE_URL}/v1/plans", headers=headers, params=params)
